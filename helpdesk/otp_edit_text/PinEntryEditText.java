package com.amysoftech.helpdesk.otp_edit_text;
...
public class PinEntryEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            context.getTheme().resolveAttribute(androidx.constraintlayout.widget.R.attr.colorControlActivated,
                    outValue, true);
            final int colorActivated = outValue.data;
            mColors[0] = colorActivated;

            context.getTheme().resolveAttribute(com.google.android.material.R.attr.colorPrimaryDark,
                    outValue, true);
            final int colorDark = outValue.data;
            mColors[1] = colorDark;

            context.getTheme().resolveAttribute(com.google.android.material.R.attr.colorControlHighlight,
                    outValue, true);
